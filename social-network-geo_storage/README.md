...
```
cd existing_repo
git remote add origin https://gitlab.skillbox.ru/javapro_team50/social-network-geo_storage.git
git branch -M master
...
- [ ] [Set up project integrations](https://gitlab.skillbox.ru/javapro_team50/social-network-geo_storage/-/settings/integrations)
