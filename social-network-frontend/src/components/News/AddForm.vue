  ...
  setup(props, { emit }) {
    ...
    onMounted(() => {
      if (props.info && props.info.imagePath) {
        ...
        oldImageLink.value = props.info.imagePath;
      }
      if (props.edit) {
    ...
    const submitForm = async () => {
      ...
      if (photo.value) {
        ...
        imagePath.value = "";
        if (oldImageLink.value) {
          axios.get("/storage/deleteByLink", { params : { linkToDelete: props.info.imagePath }});
        }
